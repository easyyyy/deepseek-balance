...
if (cost != null) {
  w.addSpacer(6);
  // Labels row
  const rowL = w.addStack();
  let lb1 = rowL.addText("本月");
  lb1.font = Font.systemFont(11);
  lb1.textColor = new Color("#8b8fa3");
  rowL.addSpacer();
  let lb2 = rowL.addText("Token");
  lb2.font = Font.systemFont(11);
  lb2.textColor = new Color("#8b8fa3");
